      ...
      {inView && (
        <div ref={animationRefference}>
          ...
          <div className="mt-4 text-justify max-w-prose md:text-lg">
            I am a <span className="italic text-[#00aeff]">Dedicated and Inquisitive</span>{" "}
            Front-end Developer. With the expert guidance of several Software and Front-end
            Development professionals I have managed to progress swiftly and understand the market
            standards for writing{" "}
            <span className="italic text-[#00aeff]">Clean and Professional code</span>. <br />{" "}
            ...
            <span className="italic text-[#00aeff]"> gets me Inspired</span> every single time to{" "}
            <span className="italic text-[#00aeff]">Explore new Possibilities</span>.
            <br /> <br />
            For all of my skills click <span className="italic text-[#00aeff]">Resume</span> and for
            all of my latest projects click
            <span className="italic text-[#00aeff]"> Projects</span>. Feel free to explore my{" "}
            <span className="italic text-[#00aeff]">Github</span> or contact me using the
